...
module.exports = class PriorityQueue {
  // This is just a hack to give more type control when constructing the `PriorityQueue`
  /**
   * @param {Array<T>} initialHeap
   */
  constructor(initialHeap = []) {
    if (!Array.isArray(initialHeap) || initialHeap.length !== 0) {
      throw new Error("The initial heap must be an empty array");
    }
